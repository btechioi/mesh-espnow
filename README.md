...
**Metric-based self-forming/self-healing mesh for ESP32. No Wi-Fi infrastructure, no IP stack, no ESP-MESH.**
...
|---------|--------------|
| **Routing** | Composite metric: hop count + RSSI + battery + capabilities + reliability |
